...
Java_com_antplay_nvstream_jni_MoonBridge_init(JNIEnv *env, jclass clazz) {
    (*env)->GetJavaVM(env, &JVM);
    GlobalBridgeClass = (*env)->NewGlobalRef(env, (*env)->FindClass(env, "com/antplay/nvstream/jni/MoonBridge"));
...
Java_com_antplay_nvstream_jni_MoonBridge_startConnection(JNIEnv *env, jclass clazz,
